document.addEventListener('DOMContentLoaded', () => {
    ...
    function openLightbox(images, index) {
        ...
        prevBtn.textContent = '\u2039';
        prevBtn.style.cssText = 'position:fixed;top:50%;left:20px;transform:translateY(-50%);z-index:10000;width:48px;height:48px;display:flex;align-items:center;justify-content:center;border-radius:14px;cursor:pointer;font-size:2rem;line-height:1;background:rgba(255,200,50,0.12);border:1px solid rgba(255,200,50,0.25);color:#f5c542;box-shadow:inset 0 1px 1px rgba(255,255,255,0.2),0 4px 16px rgba(0,0,0,0.3),0 0 12px rgba(255,200,50,0.12);-webkit-backdrop-filter:blur(40px);backdrop-filter:blur(40px);transition:opacity 0.2s,transform 0.2s;';
        ...
        nextBtn.textContent = '\u203A';
        nextBtn.style.cssText = 'position:fixed;top:50%;right:20px;transform:translateY(-50%);z-index:10000;width:48px;height:48px;display:flex;align-items:center;justify-content:center;border-radius:14px;cursor:pointer;font-size:2rem;line-height:1;background:rgba(101,207,114,0.10);border:1px solid rgba(101,207,114,0.25);color:#65CF72;box-shadow:inset 0 1px 1px rgba(255,255,255,0.2),0 4px 16px rgba(0,0,0,0.3),0 0 12px rgba(101,207,114,0.15);-webkit-backdrop-filter:blur(40px);backdrop-filter:blur(40px);transition:opacity 0.2s,transform 0.2s;';
